...
describe('xzdoc theme', function () {
  it('should show default themes', function (done) {
    exec('node ' + __dirname + '/../bin/xzdoc theme list', function (err, stdout) {
  ...
  it('should export theme ok', function (done) {
    exec('cd ' + __dirname + '/example' + ' && node ' + __dirname + '/../bin/xzdoc theme export', function (err, stdout) {
      expect(err).not.to.be.ok();
  ...
  it('should export theme pomelo ok', function (done) {
    exec('cd ' + __dirname + '/example' + ' && node ' + __dirname + '/../bin/xzdoc theme export -s pomelo', function (err, stdout) {
      expect(err).not.to.be.ok();
      expect(stdout).to.contain('Exported at ');
      expect(stdout).to.contain('You can edit ');
      expect(stdout).to.contain('pomelo');
  ...
  it('should export themes wordpress ok', function (done) {
    exec('cd ' + __dirname + '/example' + ' && node ' + __dirname + '/../bin/xzdoc theme export -s wordpress', function (err, stdout) {
      expect(err).not.to.be.ok();
      expect(stdout).to.contain('Exported at ');
      expect(stdout).to.contain('You can edit ');
      expect(stdout).to.contain('wordpress');
